...
function SchedulingPanel({ restaurantId }) {
  const auth = useAuth()
  const access = useBackOfficeAccess(auth, restaurantId)
  const canEditScheduling = access.can('scheduling.edit')
  ...
  const saveCoverageBlockPayload = async (form, options = {}) => {
    if (!canEditScheduling) {
      setStatus('You have view-only scheduling access.')
      return null
    }
  ...
  }, [restaurantId, access.loading, canEditScheduling])
  ...
  const saveManagerNote = async () => {
    if (!canEditScheduling) {
      setNoteStatus('You have view-only scheduling access.')
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-white/10 bg-white/[0.035] p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <button
              ...
              className="rounded-xl bg-dash-gold px-4 py-2 text-sm font-semibold text-black transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
            >
              Generate draft
            </button>
          </div>
        ...
        {!canEditScheduling && <p className="mt-4 text-sm text-dash-secondary">View-only access: schedule changes and approvals are disabled.</p>}
      </section>
            ...
            {selectedDiagnostic ? (
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button type="button" disabled={!canEditScheduling} onClick={() => void saveSelectedShift()} className="rounded-xl bg-dash-gold px-4 py-2 text-sm font-semibold text-black transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40">Save</button>
                  ...
                  <button type="button" disabled={!canEditScheduling} onClick={() => void deleteSelectedShift()} className="rounded-xl border border-red-400/30 px-4 py-2 text-sm font-semibold text-red-100 transition hover:border-red-300/70 disabled:cursor-not-allowed disabled:opacity-40">Remove</button>
                </div>
              </div>
            )}
          </aside>
                  ...
                  {request.status === 'pending_manager' ? (
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <button
                        ...
                        className="rounded-xl border border-red-400/30 px-4 py-2 text-sm font-semibold text-red-100 transition hover:border-red-300/70 disabled:cursor-not-allowed disabled:opacity-40"
                      >
                        Deny
                      </button>
                    </div>
                  ...
                  <div key={request.id} className="grid gap-3 rounded-xl border border-white/10 bg-white/[0.025] p-4 lg:grid-cols-[1fr_170px_210px] lg:items-center">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        disabled={!canEditScheduling || request.status === 'approved'}
                      ...
                      <button
                        ...
                        disabled={!canEditScheduling || request.status === 'denied'}
      ...
      {activeSchedulingTab === 'config' && (
        ...
        <section className="grid gap-4 lg:grid-cols-[1fr_360px]">
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.025]">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
              ...
              <div className="flex flex-wrap gap-2">
                <button type="button" disabled={!canEditScheduling} onClick={() => void regenerateCoverageDefaults()} className="rounded-xl border border-white/10 px-4 py-2 text-sm font-semibold text-dash-secondary transition hover:border-dash-gold/60 hover:text-dash-cream disabled:cursor-not-allowed disabled:opacity-40">Re-calculate suggestions</button>
                <button type="button" disabled={!canEditScheduling} onClick={() => startNewBlock()} className="rounded-xl border border-white/10 px-4 py-2 text-sm font-semibold text-dash-secondary transition hover:border-dash-gold/60 hover:text-dash-cream disabled:cursor-not-allowed disabled:opacity-40">New block</button>
              </div>
            </div>
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5">
              ...
              <div className="mt-4 space-y-3">
                ...
                />
                <div className="grid grid-cols-3 gap-2">
                  <button type="button" disabled={!canEditScheduling} onClick={() => void saveCoverageBlock()} className="rounded-xl bg-dash-gold px-4 py-2 text-sm font-semibold text-black transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40">Save block</button>
                  <button
                    type="button"
                    onClick={() => {
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5">
              ...
              <button
                ...
                disabled={!canEditScheduling || !note.trim()}
            ...
            {requestPolicy && (
              <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5">
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                  ...
                  <button type="button" disabled={!canEditScheduling} onClick={() => void saveRequestPolicy()} className="rounded-xl border border-white/10 px-4 py-2 text-sm font-semibold text-dash-secondary transition hover:border-dash-gold/60 hover:text-dash-cream disabled:cursor-not-allowed disabled:opacity-40">Save limits</button>
                </div>
              </div>
            )}
          </aside>
        ...
        <section className="rounded-2xl border border-white/10 bg-white/[0.035] p-5">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <button type="button" onClick={discardRequestPolicy} className="rounded-xl border border-white/10 px-4 py-2 text-sm font-semibold text-dash-secondary transition hover:border-dash-gold/60 hover:text-dash-cream">Cancel</button>
              <button type="button" disabled={!canEditScheduling} onClick={() => void saveRequestPolicy()} className="rounded-xl bg-dash-gold px-4 py-2 text-sm font-semibold text-black transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40">Save weights</button>
            </div>
          </div>
