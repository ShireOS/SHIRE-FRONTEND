  ...
  return (
    <Modal title="Visible report sections" onClose={onClose}>
      ...
      <div className="mt-5 flex justify-end gap-2">
        <IconButton label="Cancel" icon={X} onClick={onClose} disabled={saving} />
