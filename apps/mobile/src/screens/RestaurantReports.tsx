...
export default function RestaurantReportsScreen() {
  ...
  return (
    <View style={styles.screen}>
      ...
      <EmailModal visible={modal === 'email'} recipients={recipients} canManage={canManageRecipients} deliveryEnabled={emailDelivery.enabled} disabledReason={emailDelivery.reason} onClose={() => setModal(null)} onSave={saveRecipient} onDelete={removeRecipient} onTest={testRecipient} />
    </View>
  );
}
...
function EmailModal({
  visible, recipients, canManage, deliveryEnabled, disabledReason,
