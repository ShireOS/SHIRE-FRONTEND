...
const categoryConfig = {
  ...
  dog: { label: 'Dogs', icon: Dog, color: 'text-dash-tertiary', bgColor: 'bg-dash-surface', borderColor: 'border-dash-border', desc: 'Consider removing' }
}
  ...
  return (
    <Card>
      <CardContent className="p-6">
        <h3 className="font-semibold text-dash-cream mb-4">Menu Engineering Matrix</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className={`p-4 rounded-xl border ${categoryConfig.cow.borderColor} ${categoryConfig.cow.bgColor}`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold text-dash-cream">{categoryConfig.cow.label}</span>
            </div>
            <p className="text-xs text-dash-tertiary mb-3">{categoryConfig.cow.desc}</p>
            <div className="space-y-2">
              {categories.cow.map(item => (
                <div key={item.id} className="flex items-center justify-between text-sm">
                  <span className="text-dash-secondary">{item.name}</span>
                  <span className="text-dash-tertiary">${item.margin} margin</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className={`p-4 rounded-xl border ${categoryConfig.star.borderColor} ${categoryConfig.star.bgColor}`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold text-dash-cream">{categoryConfig.star.label}</span>
            </div>
            <p className="text-xs text-dash-tertiary mb-3">{categoryConfig.star.desc}</p>
            <div className="space-y-2">
          ...
          <div className={`p-4 rounded-xl border ${categoryConfig.dog.borderColor} ${categoryConfig.dog.bgColor}`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold text-dash-cream">{categoryConfig.dog.label}</span>
            </div>
            <p className="text-xs text-dash-tertiary mb-3">{categoryConfig.dog.desc}</p>
            <div className="space-y-2">
          ...
          <div className={`p-4 rounded-xl border ${categoryConfig.puzzle.borderColor} ${categoryConfig.puzzle.bgColor}`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold text-dash-cream">{categoryConfig.puzzle.label}</span>
            </div>
            <p className="text-xs text-dash-tertiary mb-3">{categoryConfig.puzzle.desc}</p>
            <div className="space-y-2">
        ...
        {/* Axis Labels */}
        <div className="mt-4 flex justify-between text-xs text-dash-tertiary">
