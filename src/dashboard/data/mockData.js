...
// Reservation Configuration Data
export const reservationSettings = {
  ...
  pacing_rules: [
    { id: 'pr-1', window_minutes: 15, max_covers_per_window: 20 },
    { id: 'pr-2', window_minutes: 30, max_covers_per_window: 35 },
  ],
  channel_rules: [
    { channel: 'host', is_enabled: true },
    { channel: 'phone', is_enabled: true },
    { channel: 'web', is_enabled: true },
    { channel: 'app', is_enabled: false },
  ],
  default_slot_interval_minutes: 30,
  default_min_party_size: 1,
  default_max_party_size: 10,
  auto_confirm: true,
  confirmation_lead_hours: 24,
  updated_at: '2025-01-08T14:30:00Z',
}

export const reservationBlackouts = [
  {
    id: 'bo-1',
    location_id: 'default',
    date: '2025-12-25',
  ...
  },
  {
    ...
    start_time: '17:00',
    end_time: '22:00',
    reason: "New Year's Eve - Private Event",
    status: 'active',
    created_at: '2025-01-01T10:00:00Z',
    updated_at: '2025-01-01T10:00:00Z',
  },
  ...
  },
  {
    ...
    start_time: '17:00',
    end_time: '22:00',
    reason: "Valentine's Day - Prix Fixe Only",
    status: 'cancelled',
    created_at: '2025-01-01T10:00:00Z',
...
export const reservationBootstrapDefaults = {
  service_periods: [
    {
      id: 'sp-default-dinner',
      name: 'Dinner',
      days_of_week: ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'],
      start_time: '17:00',
      end_time: '22:00',
  ...
  pacing_rules: [
    { id: 'pr-default-1', window_minutes: 15, max_covers_per_window: 15 },
  ],
  channel_rules: [
    { channel: 'host', is_enabled: true },
    { channel: 'phone', is_enabled: true },
