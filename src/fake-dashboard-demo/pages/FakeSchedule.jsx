...
const nextWeekSchedule = {
  ...
  staff: [
    ...
    // ── SERVERS ──
    { name: 'Destiny W.', role: 'Server', shifts: ['6-2', 'OFF', '6-2', '6-2', '6-2', '6-2', 'OFF'], isTraining: [false, false, false, false, false, false, false] },
    { name: 'Marcus J.', role: 'Server', shifts: ['OFF', '6-2', '6-2', 'OFF', '6-2', '6-2', '6-2'], isTraining: [false, false, false, false, false, false, false] },
    { name: 'Tiffany R.', role: 'Server', shifts: ['6-2', '6-2', 'OFF', '6-2', 'OFF', '6-2', '6-2'], isTraining: [false, false, false, false, false, false, false] },
    { name: 'Carlos M.', role: 'Server', shifts: ['7-2', '7-2', '7-2', '7-2', '6-2', 'OFF', '6-2'], isTraining: [false, false, false, false, false, false, false] },
    { name: 'Jordan K.', role: 'Server', shifts: ['7-1', 'OFF', '7-1', '7-2', '7-2', '7-2', 'OFF'], isTraining: [true, false, true, false, false, false, false] },
  ...
  warnings: [
    ...
    'Jordan K. and Elijah N. both in training — avoid scheduling solo on peak days',
...
const nextWeekAISuggestion = {
  ...
  changes: [
    ...
    { type: 'remove', staff: 'Jordan K. (training)', day: 'THU', shift: 'convert to full' },
...
const currentWeekReasoning = [
  ...
  // Servers
  { staff: 'Destiny W.', role: 'Server', confidence: 0.93, summary: 'Top performer on peak weekend coverage. Monday off balances 5-day week.', reasons: ['Highest efficiency (94%) — prioritized for Fri/Sat/Sun brunch peak', 'Monday off — lowest traffic day, minimal revenue impact', 'Opening shift (6AM) on weekends to lead pre-rush prep', 'Historically generates $218/shift in weekend tips', 'Consecutive days capped at 5 per fatigue policy'] },
  { staff: 'Marcus J.', role: 'Server', confidence: 0.90, summary: 'Mid-week anchor. Tuesday off; Sunday off prevents 6-day stretch.', reasons: ['Strong weekend performer ($156 avg tips) — kept on Fri/Sat peak', 'Tuesday off staggered opposite Destiny for max senior coverage', 'Section B specialist — fastest turns in his zone (34min avg)'] },
  { staff: 'Jordan K.', role: 'Server', confidence: 0.76, summary: '6-week new hire. Training on slow days, building to full shifts.', reasons: ['Training paired with Tue/Thu (slow days) for shadowing without rush', 'Shortened shifts (7-1) give seniors bandwidth to mentor', 'Efficiency at 78% — needs 2 more weeks before solo peak assignment'] },
  { staff: 'Aaliyah B.', role: 'Server', confidence: 0.88, summary: 'Covers Monday when Marcus is off. Strong weekday performer.', reasons: ['6AM opening on Mon ensures floor presence when senior servers are off', 'Tuesday off balances 5-day week', 'Consistent weekend coverage supports spring break staffing'] },
  // Hosts
...
const nextWeekReasoning = [
  ...
  // Servers
  { staff: 'Destiny W.', role: 'Server', confidence: 0.94, summary: 'Top server on 5-day peak schedule. Tuesday and Sunday off for recovery.', reasons: ['94% efficiency — handles projected 28 covers/shift on Saturday', 'Tuesday off honored (low-traffic, 33min avg turn)', 'Sunday off after 5-day spring break stretch prevents burnout', 'Opening shifts (6AM) on peak days for team coordination'] },
  { staff: 'Marcus J.', role: 'Server', confidence: 0.91, summary: 'Full weekend for spring break. Mon/Thu off staggered opposite Destiny.', reasons: ['$156 avg weekend tips — essential for spring break Sat/Sun', 'Off days staggered opposite Destiny for max senior coverage', 'Section B specialization reduces seating friction during high turnover'] },
  { staff: 'Jordan K.', role: 'Server', confidence: 0.78, summary: 'Training moved to Mon/Wed. Full shifts Thu-Sat to build peak-day confidence.', reasons: ['Training shifted to Mon/Wed — slowest spring break days for focused mentoring', 'Full Thursday serves as practice ramp before weekend', 'Friday/Saturday full shifts build confidence at progressively higher volume', 'Saturday is first solo peak-day trial — Destiny available as backup'] },
  { staff: 'Aaliyah B.', role: 'Server', confidence: 0.89, summary: 'Full spring break coverage Mon-Sat. Sunday off prevents overtime.', reasons: ['Covers Monday (Marcus off) and Friday (Tiffany off) gaps', 'Sunday off keeps hours under 40h at projected 38.5h', 'Opening shifts support spring break tourist early brunch crowd'] },
  { staff: 'Tyler H.', role: 'Server', confidence: 0.85, summary: 'Wed-Sun schedule covers spring break peak days. New to weekends.', reasons: ['5-day schedule concentrated on Wed-Sun for maximum weekend impact', 'Mon/Tue off since he\'s lowest-seniority — seniors cover early week', 'Spring break weekend his first full Sat/Sun — paired with Destiny\'s section'] },
  // Hosts
